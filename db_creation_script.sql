...
-- Table TCATEGORISER
CREATE TABLE TCATEGORISER (
  IdCaterie INT IDENTITY(1,1) PRIMARY KEY,
...
-- Table TCATEGORISER_LIVRES
CREATE TABLE TCATEGORISER_LIVRES (
  IdCaterie INT,
  IdLivre INT,
  CONSTRAINT PK_TCATEGORISER_LIVRES PRIMARY KEY (IdCaterie, IdLivre),
  CONSTRAINT FK_CATERIES_LIVRES_CATERIE FOREIGN KEY (IdCaterie)
      REFERENCES TCATEGORISER(IdCaterie) ON DELETE CASCADE,
